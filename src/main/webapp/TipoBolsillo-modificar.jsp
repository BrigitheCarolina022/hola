...
<body>
    ...
    <body>
        <center>
            <br>
        <div id="formContent">
            <h1>Actualizar Tipo de bolsillo</h1>
            <br>
        <form action="tipobolsillo" method="post">
            <div class="form-group">
                <label for="Nequi">Nequi</label>
                <input type="text" name="Nequi" id="Nequi" class="Nequi"  value="${tipobolsillo.Nequi}" >
            </div>
            <div class="form-group">
                <label for="Daviplata">Daviplata</label>
                <input type="text" name="Daviplata" id="Daviplata" class="Daviplata" value="${tipobolsillo.Daviplata}">
            </div>
