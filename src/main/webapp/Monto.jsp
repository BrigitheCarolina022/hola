...
<br>
                    ...
                    <c:forEach var="Monto" items="${Monto}">
                        <tr>
                            <td>${Monto.getId_Monto()}</td>
                            <td>${Monto.getMonto()}</td>

                            <td>
                                <a Monto="button" class="btn btn-warning" href="monto?accion=Monto-modificar">
            ...
            <a type="button" class="btn btn-primary" href="monto?accion=Monto-add">
